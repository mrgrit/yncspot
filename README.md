...
역할별 사용법과 데이터 운영 가이드는 [`doc/`](doc/) 디렉터리에 정리되어 있습니다. → **[매뉴얼 홈](doc/README.md)**

| 문서 | 대상 | 내용 |
|---|---|---|
| [01. 시스템 개요](doc/01-시스템-개요.md) | 전체 | 목적·핵심 개념(트랙·등급·보상·3영역)·역할·화면 지도 |
| [02. 빠른 시작](doc/02-빠른-시작.md) | 전체 | 접속·로그인·공통 UI·외부 네트워크 접속 |
| [03. 참여자 매뉴얼](doc/03-참여자-매뉴얼.md) | 참여 청년 | 홈·Spot·AI 검수·학습·채용·포트폴리오·배지·AI 상담 |
| [04. 운영자 매뉴얼](doc/04-운영자-매뉴얼.md) | 사업단 운영자 | 대시보드·참여자·교육·Spot·기업·취업매칭·수료생·보고서 |
| [05. 관리자 · 데이터 관리](doc/05-관리자-데이터관리.md) | 시스템 관리자 | 실데이터 입력·일괄 가져오기·계정/권한·감사·백업 |
| [06. 협약기업 매뉴얼](doc/06-협약기업-매뉴얼.md) | 협약기업 | 인재풀 검색·채용 공고·채용 통계 |
| [07. 참고 자료](doc/07-참고자료-데이터모델·용어집.md) | 전체 | 데이터 모델·상태값·자동화 규칙·FAQ·용어집 |
| 📊 [요구사항 정의서](doc/요구사항정의서.xlsx) | 전체 | 기능/비기능/데이터/권한/규칙 요구사항 엑셀(8시트) |
